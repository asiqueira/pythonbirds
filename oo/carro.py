...
class Direcao:
    ...
    def girar_a_direita(self):
        if self.direcao.index(self.valor) == len(self.direcao) - 1:
            self.valor = self.direcao[0]
        else:
            self.valor = self.direcao[self.direcao.index(self.valor) + 1]

    def girar_a_esquerda(self):
        if self.direcao.index(self.valor) == 0:
            self.valor = self.direcao[len(self.direcao) - 1]
        else:
            self.valor = self.direcao[self.direcao.index(self.valor) - 1]
